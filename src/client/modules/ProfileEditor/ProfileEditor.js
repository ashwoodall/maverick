...
// Thirdparty
import { Avatar, Button, Checkbox, FontIcon, Input, RadioGroup, RadioButton } from 'react-toolbox'
					...
					<Panel title='Social Media' subTitle='(optional)'>
						<Flexbox className={ theme.group } flex='70' layout='row' align='center center'>
							<Flexbox layout='column' flex>
								...
								<p>Oh-hi won’t post anything to your accounts or pull any information from them.</p>
					...
					<Panel title='History with the Military' subTitle='(optional)'>
						<Flexbox className={ theme.group } flex='70' layout='row' align='center center'>
							<Flexbox layout='column' flex>
								...
								<h4>Fort Hood</h4>
								<p>Recent or upcoming PCS? Change current duty station</p>
